...
const categories = ['Fiction','Non-Fiction','Self-Help','Education','Poetry','Biography','Business']

const sampleBooks = [
  { id: 1, title: 'Winds of Change', author: 'A. Sharma', category: 'Fiction', price: 299, type: ['eBook','Paperback'], cover: 'https://images.unsplash.com/photo-1529651737248-dad5e287768e?q=80&w=900&auto=format&fit=crop' },
  { id: 2, title: 'Startup Playbook', author: 'R. Verma', category: 'Business', price: 399, type: ['eBook','Paperback'], cover: 'https://images.unsplash.com/photo-1543002588-bfa74002ed7e?q=80&w=900&auto=format&fit=crop' },
  { id: 3, title: 'Mindset Mastery', author: 'K. Gupta', category: 'Self-Help', price: 249, type: ['eBook'], cover: 'https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?q=80&w=900&auto=format&fit=crop' },
  { id: 4, title: 'Poems of Dawn', author: 'S. Iqbal', category: 'Poetry', price: 199, type: ['Paperback'], cover: 'https://images.unsplash.com/photo-1519682577862-22b62b24e493?q=80&w=900&auto=format&fit=crop' },
]
...
export default function Store() {
  const booksByCategory = useMemo(() => {
    return categories.map((cat) => ({
      name: cat,
      items: sampleBooks.filter((b) => b.category === cat)
    }))
  }, [])
            ...
            <div key={name} className="mt-10 first:mt-0">
              ...
              {items.length === 0 ? (
                ...
                <div className="mt-4 grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                  {items.map((b) => (
                    <div key={b.id} className="rounded-2xl border border-gray-100 overflow-hidden hover:shadow-md transition-shadow">
